...
class Help(commands.Cog):
    ...
    async def help_command(self, ctx):
        ...
        embed.add_field(name="?goalie_tierlist", value="goalie_tierlist 명령어 정보를 확인할 수 있습니다.", inline=False)
    ...
    async def release_command(self, ctx):
        ...
        embed.add_field(name="Developer", value="hongs0312", inline=False)
        embed.add_field(name="Content", value="Initial release", inline=False)
